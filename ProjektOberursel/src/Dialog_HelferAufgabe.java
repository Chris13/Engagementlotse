...
public class Dialog_HelferAufgabe extends JDialog {
	...
	public static void main(String[] args) {
		try {
			Dialog_AufgabeHelfer dialog = new Dialog_AufgabeHelfer(null, "hID","hName");
	...
	public Dialog_HelferAufgabe(JFrame parent,String hId, String hName) {
		super(parent,true);
		id = hId;
		helferName = hName;
