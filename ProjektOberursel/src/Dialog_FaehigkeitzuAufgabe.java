...
public class Dialog_FaehigkeitzuAufgabe extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public Dialog_FaehigkeitzuAufgabe(JFrame parent,String hId, String hName) {
		super(parent,true);
		id = hId;
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				JLabel lblZugeordneteFhigkeiten = new JLabel("<html><u>Zugeordnete Fähigkeiten:</u></html>");
	...
	private void aenderungenSpeichern()
	{
		...
		if(!CS_SqlAbfragen.aufgabehasfaehigkeitsql(arraytmp,id))
	...
	private void faehigkeitenLaden()
	{
		...
		try
		{
			CS_DataBaseConnect.dbQuery(CS_SqlAbfragen.faehigkeitenzuaufgabesql(id),true);
